...
(define (parse-code-span text nodes delim-stack nodes-stack)
...
(define (parse-char text nodes delim-stack nodes-stack)
  (if (text-end? text)
      ...
      (case (text-char text)
        ((#\newline) (parse-newline text nodes delim-stack nodes-stack))
        ((#\\) (parse-backslash text nodes delim-stack nodes-stack))
        ((#\`) (parse-code-span text nodes delim-stack nodes-stack))
